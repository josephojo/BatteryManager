classdef MCP2210_USB2SPI
    ...
    properties (Constant)
        ...
        DEFAULT_CSPIN 			= uint32(0x00);     % What pin is being used as CS. Default is GP5 or B00100000.
        
%         DEFAULT_GPIO_PIN_DES    = uint8([0 1 2 2 2 0 2 0 0]); % LSB ... MSB. 0=GPIO, 1=CS, 2=DedicatdFunc
