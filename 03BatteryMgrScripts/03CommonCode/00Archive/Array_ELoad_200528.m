classdef Array_ELoad
    ...
    methods
        ...
        function obj = Array_ELoad(varargin)
            ...
            for i = 1:length(varargin)
                ...
                if (strcmpi(var, 'string') || strcmpi(var, 'char'))...
                    ...
                    obj.SerialObj = s;
                    obj.COMBaudRate = 38400; s.BaudRate = obj.COMBaudRate;
        ...
        function [data, reply] = MeasureVoltCurr(obj)
            ...
            if nargin == 1
                ...
                %                 end
                %                 t2 = toc - t1;
                %                 disp("open Serial time = " + num2str(t2,'%.3f')+ " seconds");
                ...
                %                 t2 = toc - t1;
                %                 disp("close Serial time = " + num2str(t2,'%.3f')+ " seconds");
