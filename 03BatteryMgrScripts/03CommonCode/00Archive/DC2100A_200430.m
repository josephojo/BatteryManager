...
%             disp("Count " + obj.count + ": " + num2str(toc(xx)) + "ms");            
        ...
        function USBDataIn_Parser(obj, new_data)
            ...
            % Add any data that might been incomplete from the previous call 
            new_data = [char(obj.buf_dropped), new_data]
            obj.buf_dropped = '';
            ...
            while ind < length(new_data)
                ...
                if(isKey(obj.USB_Parser_Response_DataLengths, key))
                    ...
                    % expect
                    if (length(new_data) - ind + 1) >= response_length
                        for i = ind : ind + response_length - 1
                            obj.buf_in.add(new_data(i));
                        end
                    ...
                    obj.USB_Parser_Buffer_Dropped = obj.USB_Parser_Buffer_Dropped + key;
        ...
        function obj = DC2100A(COMport, errLogApp, varargin)
            ...
            try
                ...
                elseif status == ErrorCode.NO_ERROR
                    ...
                    elseif obj.useUSBTerminator == false
