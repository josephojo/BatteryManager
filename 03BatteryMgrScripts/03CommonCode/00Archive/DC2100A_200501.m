classdef DC2100A < handle
    ...
    properties (SetAccess  = private)
        ...
        useUSBTerminator = true; % Should the terminator be used to receive data from serial?
    ...
    properties
        ...
        %  *** Cell Level Data
        num_cells_connected = 8; % User defined value indicating how many cells were connected. Used to flag OV/UV.
...
%                     obj.USBTimer.TasksToExecute = 1000;
                    ...
                    ConfigConnectedCells(obj, DC2100A.NUCLEO_BOARD_NUM, obj.num_cells_connected);
        ...
        function SelectBoard(obj, board_num)
        ...
        function Timed_Balance_Write(obj, board_num, bal_actions, balance_timer)
            ...
            for cell_num = 0 : DC2100A.MAX_CELLS -1
                if bal_actions(cell_num +1) == LTC3300.Cell_Balancer.BALANCE_ACTION.None...
                    ...
                    balancer_state = uint32(balance_timer(cell_num +1) / LTC3300.Cell_Balancer.BALANCE_TIME_RESOLUTION);
        ...
        function Set_OVUV_Threshold(obj, Vmax, Vmin)
            ...
            try
                ...
                obj.buf_out.add(DC2100A.USB_PARSER_UVOV_THRESHOLDS_COMMAND...
                    + dec2hec(uint32(obj.vMax / DC2100A.VOLTAGE_RESOLUTION), 4)...
                    + dec2hec(uint32(obj.vMin / DC2100A.VOLTAGE_RESOLUTION), 4));
