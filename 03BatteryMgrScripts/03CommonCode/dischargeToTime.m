...
%
%   Inputs: 
%       targTime        : Target time in seconds (s)
%       dischargeCurr   : Current to Discharge (A)
%       varargin        
...
%			dataQ         	= [],     		: Pollable DataQueue for real-time data transfer between 2 parallel-run programs such as the function and GUI
%			errorQ        	= [],     		: Pollable DataQueue for real-time error data (exceptions) transfer between 2 parallel-run programs such as the function and GUI
...
%     testTimer = tic; % Start Timer for read period
    ...
    % While the time so far is less than the limit
