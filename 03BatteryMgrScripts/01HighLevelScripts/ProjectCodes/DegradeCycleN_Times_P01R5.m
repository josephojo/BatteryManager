...
try
    ...
    Filename   = "PK01_dgrdData_01S";
    Purpose    = "57 cycles of Degradation Data after collecting" + ...
                " training and testing for P01_Rev5";
...
%     end
    ...
    numIterations = 50; % Number of times to run the profile
    ...
    if strcmpi (cellConfig, 'parallel')
        ...
        adjCurr = batteryParam.ratedCapacity(cellIDs(1))*c_rate; % X of rated Capacity
    end
