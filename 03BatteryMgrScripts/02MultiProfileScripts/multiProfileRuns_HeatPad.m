...
try
    ...
    cellIDs = ["AA6"]; % ID in Cell Part Number (e.g BAT11-FEP-AA1). Defined again in initializeVariables
...
%     AhCounter(cellIDs, 1);
    ...
    Filename   = "AA6_FaultedData_03L";
    Purpose    = "NN Faulted Data consisting of all drive cycles " + ...
        " with faults occuring 100s into each driving cycle for 15 seconds." + ...
        " after round 3 degrd (300 dgrd cycles for AA6)";
