...
try
    ...
    cellID = "AA1"; % ID in Cell Part Number (e.g BAT11-FEP-AA1). Defined again in initializeVariables
    ...
    endCycleProfile = length(cycleProfiles);
    ...
    saveLocation = ['C:\Users\User\Documents\Projects\03ThermalFaultDetection' ...
        '\02TestingData\']; % '\03DataGen\01CommonDataForBattery\'];

%     save(saveLocation + "003FaultyTempData_Cycle1.mat", 'resultCollection');
    save(saveLocation + "004" + cellID + "_CYData_"+ datestr(now,'yymmdd')+".mat", 'resultCollection');
