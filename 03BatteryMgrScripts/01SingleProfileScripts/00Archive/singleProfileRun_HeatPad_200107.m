...
%     AhCounter(cellIDs, 1);
    ...
    Filename   = "AA6_FaultedData_3CDchg_03L";
    Purpose    = "NN Faulted Data consisting of CC discharge at 3C. " + ...
        " Test is run for a total of 600 seconds.";
        ...
        for ii = ccProfile %startProfileInd:endProfileInd
            ...
            for i = 1:length(ccSocTargets)
                ...
                if(initialSOC > targetSOC)
                    ...
                    out = dischargeToTime(targetSOC, adjCurr, 'cellIDs', cellIDs,...
                            'trig1', runHtPad,...
                            'trig1_pin', htPadPin,...
                    ...
                    disp(newline + "Iter: " + num2str(iter) + ...
                        ...
                        num2str(prevSOC * 100)+ "%. To: " +...
                        num2str(targetSOC * 100) + "%. ") 
                    out = chargeToTime(targetSOC, adjCurr,  'cellIDs', cellIDs,...
                            'trig1', runHtPad,...
                            'trig1_pin', htPadPin,...
                            'trig1_startTime', htPadStartTime,...
                            'trig1_duration',  htPadDuration );
