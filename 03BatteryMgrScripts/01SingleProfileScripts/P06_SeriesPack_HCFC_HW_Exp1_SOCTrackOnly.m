...
ANPOT_Target = 0.005;  % Anode Potential has to be greater than 0 to guarantee no lithium deposition
...
%             mdl_Y = P06_OutputFcn_HW(mdl_X, testData.cellCurr(end, :)', readPeriod, p2, p3, p4)';
    ...
    if strcmpi(testStatus, "stop")
        ...
        testSettings.saveDir = testSettings.saveDir + metadata.startDate...
            +"_"+ metadata.startTime + "_HCFC_Exp1__ErroredOut_" ...
    ...
    elseif ~strcmpi(testStatus, "stop")
        % Save Test Data
        testSettings.saveDir = testSettings.saveDir + metadata.startDate...
            +"_"+ metadata.startTime + "_HCFC_Exp1_Successful\";
    else 
        % Save Test Data
        testSettings.saveDir = testSettings.saveDir + metadata.startDate...
            +"_"+ metadata.startTime + "_HCFC_Exp1_Failed\";
        testData.errCode = errorCode;
    end
    % Save Data
